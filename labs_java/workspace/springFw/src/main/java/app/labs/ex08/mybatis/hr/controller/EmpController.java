...
public class EmpController {
	...
	@RequestMapping(value = "/hr/{employeedId}")
	public String getEmpInfo(@PathVariable int employeedId, Model model) {
		EmpVO emp = empService.getEmpInfo(employeedId);
