...
//		HelloController controller = new HelloController();
		...
		//2) Constructor - 서비스 생성을 컨트롤러에서 분리하여 유연성 확보
...
//		
		...
		// 5) 생성자 이용
		HelloController controller = context.getBean("helloController", 
				HelloController.class);
		
		controller.hello("홍길동");
		
		// 6) Setter 이용
		HelloController controller2 = context.getBean("helloController2", 
				HelloController.class);
		
		controller2.hello("홍길동");
		
		
		HelloController controller3 = context.getBean("helloController3", 
				HelloController.class);
